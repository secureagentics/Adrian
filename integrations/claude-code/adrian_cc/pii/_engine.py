...
Vendored from ``sdk/python/adrian/pii/_engine.py`` (imports rewired
to ``adrian_cc``).  See ``_patterns.py`` for why.
"""
...
from adrian_cc.pii._patterns import Detection, PiiType, detect
from adrian_cc.pii._strategies import RedactionStrategy, apply_strategy
